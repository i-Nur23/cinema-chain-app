    ...
    <div className='flex flex-col min-h-screen main-container'>
      ...
      <div id="tooltip-bottom" role="tooltip"
        ...
        <div class="float-left my-auto">
          <button class="rounded-r-lg border h-14 bg-white" type="button" data-drawer-target="drawer-navigation"
        ...
        <div className='flex transition-transform fixed top-0 left-0 z-40 -translate-x-full' id="drawer-navigation"
             tabindex="-1" aria-labelledby="drawer-navigation-label">
          <div className=' w-64 h-screen p-4 overflow-y-auto bg-white dark:bg-gray-800 '>
            <center><h5 id="drawer-navigation-label"
                        class="text-base font-semibold text-gray-500 uppercase dark:text-gray-400">Меню</h5></center>
            <div class="py-4">
          ...
          <button className="rounded-r-lg border h-14 bg-gray-200 my-auto" type="button"
